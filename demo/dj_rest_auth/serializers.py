...
class LoginSerializer(serializers.Serializer):
    ...
    def get_auth_user_using_allauth(self, username, email, password):
        # from allauth.account import app_settings as allauth_account_settings #commenting this line

        # Authentication through email
        # if allauth_account_settings.AUTHENTICATION_METHOD == allauth_account_settings.AuthenticationMethod.EMAIL: #commenting this line
        #     return self._validate_email(email, password)                                 #commenting this line

        # Authentication through username
        # if allauth_account_settings.AUTHENTICATION_METHOD == allauth_account_settings.AuthenticationMethod.USERNAME: #commenting this line
        #     return self._validate_username(username, password)               #commenting this line
    ...
    def get_auth_user(self, username, email, password):
        ...
        """
        # if 'allauth' in settings.INSTALLED_APPS:  #commenting
            ...
            # try:                                                                    #commenting
            #     return self.get_auth_user_using_allauth(username, email, password)  #commenting
            # except url_exceptions.NoReverseMatch:                                 #commenting
            #     msg = _('Unable to log in with provided credentials.')             #commenting
            #     raise exceptions.ValidationError(msg)                               #commenting
    ...
    def validate(self, attrs):
        ...
        if not user:
            msg = _('Unable to log in with provided credentials.') # _(GeneralMessages.INVALID_CREDENTIALS)
            raise exceptions.ValidationError(msg)
...
class OTPLoginSerializer(serializers.Serializer):
    user_id = serializers.CharField(max_length=6,required = False, read_only=True)
    email = serializers.CharField(max_length=255,required = False,read_only=True)
